...
void loop()
{
  ...
  // for timing the delay in the gyroscope
  ...
  */
  ...
  //  float accel_vector_length = sqrt(pow(accel_x,2) + pow(accel_y,2) + pow(accel_z,2));
    ...
    Serial.print(dt, DEC);
    Serial.print(F("#TOT:"));              //Accelerometer angle
    Serial.print(tot_time, 2);
    Serial.print(F("#FreqCounter"));              //Accelerometer angle
    Serial.print(freqCounter);
    Serial.print(F("#GYR:"));
  ...
  float mean_time = tot_time/freqCounter ;
  // freqcounter = 1024 // there were 1024 measures of the delay
  Serial.print(F("Comptage : "));  Serial.println(freqCounter, DEC);
  Serial.print(F("moyenne : "));  Serial.println(mean_time, 6);  
  Serial.print(F("Minimum : "));  Serial.println(min_time, 6); 
  Serial.print(F("Maximum : "));  Serial.println(max_time, 6); 
